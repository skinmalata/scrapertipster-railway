...
{k:['in play','in-play','inplay','live scores','live betting','golden tip','live opportunities','watch live'],r:'Live scores and in-play tips are available to everyone on every plan, free or paid. Exclusive VIP record-cert tips are a Pro feature. Visit '+SITE.url+'/predictions/in-play'},
{k:['best picks','h2h','head to head','head-to-head','author pick','2 odds of the day'],r:'Daily Best Picks and H2H (head-to-head) Picks are curated selections based on direct match history between two teams. They are included on every plan, free or paid — see '+SITE.url+'/best-picks.html and '+SITE.url+'/author-picks.html.'},
