...
var SITE={
  ...
  pages:{
    ...
    '1x2':{url:'/predictions/1x2.html',title:'1X2 Predictions'},
    'over-2-5':{url:'/predictions/over-2-5.html',title:'Over 2.5 Goals'},
    'over-1-5':{url:'/predictions/over-1-5.html',title:'Over 1.5 Goals'},
    btts:{url:'/predictions/btts.html',title:'BTTS Yes'},
    'btts-no':{url:'/predictions/btts-no.html',title:'BTTS No'},
    corners:{url:'/predictions/corners.html',title:'Corners Predictions'},
    cards:{url:'/predictions/cards.html',title:'Cards Predictions'},
    unbeaten:{url:'/predictions/unbeaten.html',title:'Unbeaten Teams'},
...
{k:['1x2','1 x 2','match result','home win','away win','draw'],r:'1X2 betting: 1=Home Win, X=Draw, 2=Away Win. Our picks show 65%+ probability. Visit '+SITE.url+'/predictions/1x2.html for today\'s predictions.'},
...
{k:['corners','corner'],r:'Corner predictions focus on Over 9.5 corners (10+ total). We analyze team corner stats and historical data. Visit '+SITE.url+'/predictions/corners.html'},
{k:['cards','card','yellow','red','booking'],r:'Card predictions highlight matches with high booking rates. Markets: Over 4.5 (top leagues) and Over 8.5 cards. Visit '+SITE.url+'/predictions/cards.html'},
{k:['streak','winning','losing','draw streak','unbeaten','form'],r:'We track teams on winning/drawing/unbeaten streaks. Great for momentum-based betting. Visit '+SITE.url+'/predictions/unbeaten.html'},
...
{k:['page','site','website','pages','sitemap'],r:'WinFulltime pages:\n\u2022 Home - '+SITE.url+'\n\u2022 1X2 Predictions - '+SITE.url+'/predictions/1x2.html\n\u2022 Over 2.5 - '+SITE.url+'/predictions/over-2-5.html\n\u2022 Over 1.5 - '+SITE.url+'/predictions/over-1-5.html\n\u2022 BTTS Yes - '+SITE.url+'/predictions/btts.html\n\u2022 BTTS No - '+SITE.url+'/predictions/btts-no.html\n\u2022 Corners - '+SITE.url+'/predictions/corners.html\n\u2022 Cards - '+SITE.url+'/predictions/cards.html\n\u2022 Unbeaten - '+SITE.url+'/predictions/unbeaten.html\n\u2022 Ticket Builder - '+SITE.url+'/ticket-builder.html\n\u2022 Blog - '+SITE.url+'/blog/\n\u2022 About - '+SITE.url+'/about.html\n\u2022 Contact - '+SITE.url+'/contact.html'},
...
function saveEmail(e){if(!e||e.indexOf('@')===-1)return;userEmail=e;try{localStorage.setItem('wf_chat_email',e)}catch(ex){}var xhr=new XMLHttpRequest;xhr.open('POST','https://winfulltime-api.onrender.com/api/newsletter/subscribe',true);xhr.setRequestHeader('Content-Type','application/json');xhr.send(JSON.stringify({email:e,consent:true}))}
