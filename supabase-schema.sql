...
-- 11. Two Odds History table (for durable cross-restart persistence)
...
CREATE POLICY "Service can upsert two_odds_history" ON public.two_odds_history
  FOR ALL USING (true) WITH CHECK (true);

-- 12. Default VIP plans (you can customize pricing)
-- Monthly: $9.99/month
